...
namespace app_web_backend.Controllers
{
    public class ConsumosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Date,Km,Valor,Tipo,VeiculoId")] Consumo consumo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Date,Km,Valor,Tipo,VeiculoId")] Consumo consumo)
        {
            if (id != consumo.Id)
            {
                return NotFound();
